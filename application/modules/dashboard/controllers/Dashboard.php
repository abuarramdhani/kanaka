...
class Dashboard extends MX_Controller {
	...
	public function index(){
        ...
        $data['stocks_mitra'] = $this->get_data_stock('partner');
        $data['stocks_dipo_2'] = $this->get_dipo_stock();
        $data['stocks_mitra_2'] = $this->get_mitra_stock();
        $data['stocks_mitra_3'] = $this->get_mitra_stock_2();
    ...
    public function get_mitra_stock_2(){
        $user = $this->ion_auth->user()->row();
        $dataSellIn = array();
        $dataSellOut = array();
        $allDataSell = array();
    ...
    public function get_mitra_stock(){
        $user = $this->ion_auth->user()->row();
        $dataSellIn = array();
        $dataSellOut = array();
        $allDataSell = array();
    ...
    public function get_dipo_stock(){
        $user = $this->ion_auth->user()->row();
        $dataSellIn = array();
        $dataSellOut = array();
        $allDataSell = array();
