...
<div class="page-content">
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h3 class="page-title">{{ lang('menus') }}</h3>
    <!-- END PAGE TITLE-->
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div id="table-wrapper" class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject">{{ lang('menus') }}</span>
                    </div>
                    <div class="tools">
                        @if($add_access == 1)
            ...
            confirm: function() {
                ...
                $.getJSON('{{base_url()}}master/menu/update', {
                    ...
                    if(json.status == "success"){
                        toastr.success('{{lang("updated_succesfully")}}','{{ lang("notification") }}');
                        // el.closest('tr').remove();
                    }else if(json.status == "error"){
                        toastr.error('{{lang("updated_unsuccesfully")}}','{{ lang("notification") }}');
                    }
                    setTimeout(function(){
                        window.location.reload()
                    },1000);
