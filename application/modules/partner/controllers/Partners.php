        ...
        if ($this->input->is_ajax_request()) {
            ...
            if (empty($id_partner)) {
                if (!empty($get_partner->name)) {
                    ...
                    if ($save) {
                        ...
                        $data_notif = array(
                            ...
                            'City' => $city == 0 ? "-" : ucwords(strtolower(City::find($city)->name)),
                            'District' => $subdistrict == 0 ? "-" : District::find($subdistrict)->name,
                ...
                $data_old = array(
                    ...
                    'City' => $model->city == 0 ? "-" : ucwords(strtolower(City::find($model->city)->name)),
                    'District' => $model->subdistrict == 0 ? "-" : District::find($model->subdistrict)->name,
