                                    ...
                                    <li class="product-item">
                                        <div class="product-item-info">
                                            <div class="product-image">
                                                ...
                                                ?>
                                                        <img width="150" style="padding: 10px;" src="{{ base_url() }}uploads/images/products/<?= $p->image ?>">
                                                <?php 
                                                        } 
                                                    }else{
                                                ?>
                                                        <img width="150" style="padding: 10px;" src="{{ base_url() }}uploads/images/products/default.png">
                                                <?php
                                                    } 
                                                ?>
                                            </div>
