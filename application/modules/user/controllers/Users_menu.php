...
class Users_menu extends MX_Controller {
    ...
    public function index($id_user) {
        ...
        $data['access_user'] = User::find(uri_decrypt($id_user));
    ...
    public function fetch_data($id_user = "") {
        ...
        foreach ($aa_data as $row) {
            ...
            if($this->user_profile->get_user_access('Updated', 'users/account')){
                $btn_action .= '<a href="javascript:void()" onclick="edit_usermenu(\'' . uri_encrypt($row->id_user_menu) . '\')" class="btn btn-warning btn-icon-only btn-circle" data-toggle="ajaxModal" title="' . lang('update') . '"><i class="fa fa-edit"></i> </a>';
            }
            if($this->user_profile->get_user_access('Deleted', 'users/account')){
                $btn_action .= '<a href="javascript:void()" onclick="delete_usermenu(\'' . uri_encrypt($row->id_user_menu) . '\')" class="btn btn-danger btn-icon-only btn-circle" title="' . lang('delete') . '"><i class="fa fa-trash-o"></i></a>';
            }
