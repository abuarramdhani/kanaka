...
--
-- Table structure for table `m_chart_of_accounts`
--
...
--
-- Indexes for table `m_chart_of_accounts`
--
ALTER TABLE `m_chart_of_accounts`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `m_chart_of_accounts`
--
ALTER TABLE `m_chart_of_accounts`
