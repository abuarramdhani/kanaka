...
Date: 2019-07-01 07:36:48
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for t_sell_in_company_detail
-- ----------------------------
DROP TABLE IF EXISTS `t_sell_in_company_detail`;
CREATE TABLE `t_sell_in_company_detail` (
